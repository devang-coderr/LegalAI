      ...
      <div
        ...
        className={cn(
          ...
          dragOver
            ...
            : "border-[var(--border-color)] bg-[var(--bg-card)]/40 hover:border-[var(--accent-blue)] hover:bg-[var(--bg-secondary)]"
        )}
      >
        <input
          ref={inputRef}
        ...
        {!selectedFile ? (
          <>
            <div className="p-3.5 rounded-2xl bg-blue-500/10 text-blue-400 mb-3">
              <Upload className="w-6 h-6" />
            </div>
            <h4 className="text-sm font-semibold text-[var(--text-primary)]">
              Drop legal document here, or <span className="text-blue-400 underline">browse</span>
            </h4>
