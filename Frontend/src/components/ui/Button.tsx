...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantStyles = {
      ...
      secondary:
        "bg-[var(--bg-card)] text-[var(--text-primary)] border border-[var(--border-color)] hover:border-[var(--accent-blue)] hover:bg-[var(--bg-secondary)] shadow-sm focus:ring-blue-500",
      outline:
        "border border-[var(--border-color)] text-[var(--text-primary)] hover:border-[var(--accent-blue)] hover:bg-[var(--accent-blue-glow)] focus:ring-blue-500",
      gold:
