...
export function ThemeToggle({ className = "" }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`relative inline-flex h-9 w-9 items-center justify-center rounded-xl border border-[var(--border-color)] bg-[var(--bg-glass)] hover:border-[var(--accent-blue)] transition-all ${className}`}
    >
